...
const buttonVariants = cva(
  `
    ...
    rounded-xl text-sm font-bold ring-offset-background 
  ...
  `,
  {
    variants: {
      variant: {
        ...
        danger: "bg-rose-500 text-primary-foreground hover:bg-rose-400/90 border-rose-600 border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",
        premium: "bg-indigo-500 text-primary-foreground hover:bg-indigo-400/90 border-indigo-600 border-b-4 active:border-b-0",
        premiumOutline: "bg-white text-indigo-500 hover:bg-slate-100",
